...
class PersistentOnboardingScreen extends StatefulWidget {
  const PersistentOnboardingScreen({super.key});

  static const routeName = '/persistent-onboarding';

  final movingShapesPath = 'assets/rive/shapes.riv';
  final splinePath = 'assets/images/backgrounds/Spline.png';

  @override
  State<PersistentOnboardingScreen> createState() =>
      _PersistentOnboardingScreenState();
}

class _PersistentOnboardingScreenState
    extends State<PersistentOnboardingScreen> {
  @override
